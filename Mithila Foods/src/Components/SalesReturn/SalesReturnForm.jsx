...
export default function SalesReturnForm({
  ...
  customers,
  companies,
  brandFilteredItems, // ✅ RECEIVED FILTERED ITEMS
  orgs,
  manualBrand,
  setManualBrand,
      ...
      <div className="sales-return-form-grid">
        ...
        <div className="sales-return-field-group">
          ...
          <div style={{ fontSize: "11px", marginTop: "4px", color: "#666" }}>
            Good returns route to: <b>{getWarehouseForBrand(manualBrand)}</b>
          </div>
        </div>
      </div>
          ...
          <div key={row.id} className="sales-return-row-card">
            ...
            <div className="sales-return-row-grid">
              <div className="sales-return-row-field">
                <label className="form-label">Item</label>
                <ItemSearchDropdown
                  items={brandFilteredItems || []} // ✅ ONLY SHOW SELECTED BRAND ITEMS
                  value={row.item_code}
                  onSelect={(code) => handleRowChange(row.id, "item_code", code)}
              ...
              <div className="sales-return-row-field">
                ...
                <select
                  ...
                  onChange={(e) => handleRowChange(row.id, "quality", e.target.value)}
                >
                  <option value="good">Good (Restock to {getWarehouseForBrand(manualBrand)})</option>
