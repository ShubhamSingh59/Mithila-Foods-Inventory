    ...
    <section className="supplier-detail-card prl-card">
      <div className="supplier-detail-card__header prl-header">
        ...
        <div className="prl-actions">
          ...
          <button 
            ...
            title="Sort by Purchase Order Number"
          >
      ...
      <div className="supplier-detail-card__body">
        ...
        <div className="prl-filters">
          ...
          <div className="prl-filter">
            <label className="prl-label">Search (Inv/Item/Trans)</label>
            <div style={{display:'flex', gap:5}}>
        ...
        <div className="prl-table-wrap">
          <table className="prl-table">
            <thead>
              <tr>
                <th>PO #</th> {/* ✅ MOVED FIRST for "PO Order" */}
                <th>Date</th>
                {/*<th>Status</th>*/}
                <th>Order Status</th>
                <th>Order Satus Chnaged Date</th>
                
                <th>Vendor</th>
                <th>Item</th>
                
                <th>Goods Receipt No</th> {/* ✅ NEW */}
                <th>Received Date</th>
                
                <th>ERP Inv No</th> {/* ✅ RENAMED */}
                <th>Supp Inv No</th> {/* ✅ NEW */}
                
                <th className="prl-num">Qty</th>
                <th className="prl-num">Value (₹)</th>
            ...
            <tbody>
              {!loading && !displayRows.length ? (
                <tr><td colSpan={14} className="prl-empty">No rows found.</td></tr>
              ) : null}
              ...
              {displayRows.map((r, idx) => (
                <tr key={`${r.po_name}-${r.item_code}-${idx}`}>
                  ...
                  {/* ✅ PO Statuses */}
                  {/*<td><span className="prl-badge">{r.po_status}</span></td>*/}
                  <td>{r.mf_status || "—"}</td>
                  <td>{fmtDate(r.mf_status_date)}</td>
